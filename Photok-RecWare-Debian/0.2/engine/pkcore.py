        ...
        for count, file in enumerate(dirlist):
            ...
            if not ext in skip and passfile is False:
                ...
                try:
                    ...
                    print(f'provided path will not work for album decryption :/ "{os.path.join(destination, folder)}"')
                ...
                # adds mimetype name if there is not already one
                util.addname(newfile)
